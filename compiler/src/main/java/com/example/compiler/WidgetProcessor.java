...
public class WidgetProcessor extends AbstractProcessor {
    ...
    private final String mPackageName = "com.example.miczcj.vms.manager";

    ClassName mMapName = ClassName.get("java.util", "Map");
    ClassName mHashMapName = ClassName.get("java.util", "HashMap");
    ClassName mItemDescName = ClassName.get("com.example.miczcj.vms.model", "QDItemDescription");
    ClassName mBaseFragmentName = ClassName.get("com.example.miczcj.vms.base", "BaseFragment");
